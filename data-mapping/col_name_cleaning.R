...
clean_column_names <- function(df, data_src, data_mapping){
...
epc_data_cleaned <- clean_column_names(epc_data, 
                                       data_src = 'epc',
                                       data_mapping)
...
costar_props_cleaned <- clean_column_names(costar_props,
...
apts_cleaned <- clean_column_names(apts,
                                   data_src = 'apts',
                                   data_mapping)
...
valcre_cleaned <- clean_column_names(valcre, 
                                     data_src = 'valcre',
                                     data_mapping)
